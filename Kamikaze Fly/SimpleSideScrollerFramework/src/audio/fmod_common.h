...
#define FMOD_VERSION    0x00000103
...
typedef enum
{
    ...
    FMOD_SPEAKERMODE_5POINT1,          /* 5.1 speaker setup.  This includes front left, front right, center, surround left, surround right and a subwoofer. */
    FMOD_SPEAKERMODE_7POINT1,          /* 7.1 speaker setup.  This includes front left, front right, center, surround left, surround right, rear left, rear right and a subwoofer. */
...
[
    [DESCRIPTION]   
    These are speaker types defined for use with the Channel::setPanMatrix command.
    ...
    For example (FMOD_SPEAKER)7 would use the 7th speaker (also the same as FMOD_SPEAKER_REAR_RIGHT).<br>
...
typedef enum
{
    ...
    FMOD_SPEAKER_REAR_LEFT,
    FMOD_SPEAKER_REAR_RIGHT,
    
    FMOD_SPEAKER_MAX,                                       /* Maximum number of speaker types supported. */
    FMOD_SPEAKER_MONO        = FMOD_SPEAKER_FRONT_LEFT,     /* For use with FMOD_SPEAKERMODE_MONO and Channel::setPanMatrix.  Mapped to same value as FMOD_SPEAKER_FRONT_LEFT. */
...
[
    ...
    [REMARKS]
    For full flexibility of speaker assignments, use Channel::setPanMatrix.
...
{                       
    ...
    int             maxVORBIScodecs;            /* [r/w] Optional. Specify 0 to ignore. For use with FMOD_CREATECOMPRESSEDSAMPLE only.  Vorbis codecs consume 12,000 bytes per instance and this number will determine how many CELT channels can be played simultaneously.   Default = 32. */    
