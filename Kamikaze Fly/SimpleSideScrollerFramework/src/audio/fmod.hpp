    ...
    */
    ...
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setSoftwareFormat      (int samplerate, FMOD_SOUND_FORMAT format, int numoutputchannels, FMOD_DSP_RESAMPLER resamplemethod);
        FMOD_RESULT F_API getSoftwareFormat      (int *samplerate, FMOD_SOUND_FORMAT *format, int *numoutputchannels, FMOD_DSP_RESAMPLER *resamplemethod, int *bits);
        ...
        FMOD_RESULT F_API registerDSP2           (FMOD_DSP_DESCRIPTION2 *description, unsigned int *handle);
        ...
        FMOD_RESULT F_API createDSP              (FMOD_DSP_DESCRIPTION2 *description, DSP **dsp);
    ...
    */
    class ChannelControl
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setDelay               (unsigned int dspclock_start, unsigned int dspclock_fadein, unsigned int dspclock_fadeout, unsigned int dspclock_end, bool stopchannels = true);
        FMOD_RESULT F_API getDelay               (unsigned int *dspclock_start, unsigned int *dspclock_fadein, unsigned int *dspclock_fadeout, unsigned int *dspclock_end, bool *stopchannels = 0);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API addInput               (DSP *input, unsigned int priority = 0, DSPConnection **connection = 0);
        FMOD_RESULT F_API addSideChain           (DSP *source, unsigned int priority = 0, DSPConnection **connection = 0);
        ...
        // Metering
        FMOD_RESULT F_API setMeteringEnabled     (bool enabled);
        FMOD_RESULT F_API getMeteringEnabled     (bool *enabled);
        FMOD_RESULT F_API getMeteringInfo        (FMOD_DSP_METERING_INFO *info);
