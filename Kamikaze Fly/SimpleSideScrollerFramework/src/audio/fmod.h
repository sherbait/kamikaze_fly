...
FMOD_RESULT F_API FMOD_System_SetSoftwareFormat      (FMOD_SYSTEM *system, int samplerate, FMOD_SOUND_FORMAT format, int numoutputchannels, FMOD_DSP_RESAMPLER resamplemethod);
FMOD_RESULT F_API FMOD_System_GetSoftwareFormat      (FMOD_SYSTEM *system, int *samplerate, FMOD_SOUND_FORMAT *format, int *numoutputchannels, FMOD_DSP_RESAMPLER *resamplemethod, int *bits);
...
FMOD_RESULT F_API FMOD_System_RegisterDSP2           (FMOD_SYSTEM *system, FMOD_DSP_DESCRIPTION2 *description, unsigned int *handle);
...
FMOD_RESULT F_API FMOD_System_CreateDSP              (FMOD_SYSTEM *system, FMOD_DSP_DESCRIPTION2 *description, FMOD_DSP **dsp);
...
FMOD_RESULT F_API FMOD_Channel_SetDelay              (FMOD_CHANNEL *channel, unsigned int dspclock_start, unsigned int dspclock_fadein, unsigned int dspclock_fadeout, unsigned int dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT F_API FMOD_Channel_GetDelay              (FMOD_CHANNEL *channel, unsigned int *dspclock_start, unsigned int *dspclock_fadein, unsigned int *dspclock_fadeout, unsigned int *dspclock_end, FMOD_BOOL *stopchannels);
...
FMOD_RESULT F_API FMOD_ChannelGroup_SetDelay         (FMOD_CHANNELGROUP *channelgroup, unsigned int dspclock_start, unsigned int dspclock_fadein, unsigned int dspclock_fadeout, unsigned int dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT F_API FMOD_ChannelGroup_GetDelay         (FMOD_CHANNELGROUP *channelgroup, unsigned int *dspclock_start, unsigned int *dspclock_fadein, unsigned int *dspclock_fadeout, unsigned int *dspclock_end, FMOD_BOOL *stopchannels);
...
FMOD_RESULT F_API FMOD_DSP_AddInput                  (FMOD_DSP *dsp, FMOD_DSP *input, unsigned int priority, FMOD_DSPCONNECTION **connection);
FMOD_RESULT F_API FMOD_DSP_AddSideChain              (FMOD_DSP *dsp, FMOD_DSP *source, unsigned int priority, FMOD_DSPCONNECTION **connection);
...
FMOD_RESULT F_API FMOD_DSP_SetMeteringEnabled        (FMOD_DSP *dsp, FMOD_BOOL enabled);
FMOD_RESULT F_API FMOD_DSP_GetMeteringEnabled        (FMOD_DSP *dsp, FMOD_BOOL *enabled);
FMOD_RESULT F_API FMOD_DSP_GetMeteringInfo           (FMOD_DSP *dsp, FMOD_DSP_METERING_INFO *info);
